...
public class PredDel extends LocalToolBase {
	...
	void SetPoten(int pat, int k) {
		SP sp[][] = {
		 ...
		 {new SP(  1.8445, -0.1274,  1.4886,  1.6735,  0.9861,  1.2418,  2.7407,  1.4576,  0.1118, -0.3110, -0.0091, -0.9648, -0.6926, -0.4590, -0.8077, -0.5130, -0.6628, -0.3163, -0.4954, -0.8322,  0.0000,  5.4604, -6.4977, -6.4968),   // 0 - original comments removed for LaTeX compatibility
		  new SP(  1.2544, -0.0866,  1.0124,  1.1381,  0.6706,  0.8445,  1.8639,  0.9913,  0.0760, -0.2115, -0.0062, -0.6562, -0.4710, -0.3122, -0.5493, -0.3489, -0.4508, -0.2151, -0.3369, -0.5660,  0.0000,  3.7136, -4.4191, -4.4185),   // 1 - original comments removed for LaTeX compatibility
		  new SP(  2.4188, -0.2387,  1.6671,  2.0799,  1.2732,  1.4630,  3.1954,  1.5785, -0.0639, -0.5250, -0.1529, -1.1092, -0.7109, -0.7780, -0.9353, -0.8225, -1.1264, -0.3427, -0.5974, -1.1507,  0.0000,  5.2510,  2.5911,  0.9429),   // 2 - original comments removed for LaTeX compatibility
		  new SP(  1.6725, -0.1650,  1.1527,  1.4381,  0.8803,  1.0116,  2.2094,  1.0914, -0.0442, -0.3630, -0.1057, -0.7670, -0.4915, -0.5379, -0.6467, -0.5687, -0.7788, -0.2370, -0.4131, -0.7956,  0.0000,  3.6308,  1.7916,  0.6520),   // 3 - original comments removed for LaTeX compatibility
		  new SP(  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0,       0,       0.    )},  // 4 - original comments removed for LaTeX compatibility

		 {new SP(  1.7855, -0.1737,  1.4041,  1.6278,  0.9456,  1.2003,  2.6406,  1.4318,  0.1009, -0.3203, -0.0192, -0.9396, -0.6972, -0.4438, -0.7666, -0.5132, -0.0362, -0.3542, -0.4853, -0.8504,  0.0000,  5.4041, -6.4273, -6.4466),   // 0 - original comments removed for LaTeX compatibility
		  new SP(  1.1684, -0.1137,  0.9188,  1.0652,  0.6188,  0.7854,  1.7279,  0.9369,  0.0660, -0.2096, -0.0126, -0.6148, -0.4562, -0.2904, -0.5016, -0.3358, -0.0237, -0.2318, -0.3176, -0.5565,  0.0000,  3.5363, -4.2058, -4.2185),   // 1 - original comments removed for LaTeX compatibility
		  new SP(  2.3572, -0.1967,  1.5534,  1.9840,  1.1677,  1.3736,  3.0945,  1.5248, -0.0741, -0.5569, -0.1807, -1.0801, -0.6953, -0.7213, -0.9058, -0.8194, -0.0933, -0.3896, -0.5842, -1.1795,  0.0000,  5.3091,  3.0649,  1.1571),   // 2 - original comments removed for LaTeX compatibility
		  new SP(  1.5956, -0.1331,  1.0515,  1.3430,  0.7904,  0.9298,  2.0947,  1.0322, -0.0502, -0.3770, -0.1223, -0.7311, -0.4707, -0.4883, -0.6132, -0.5547, -0.0632, -0.2637, -0.3955, -0.7984,  0.0000,  3.5938,  2.0747,  0.7833),   // 3 - original comments removed for LaTeX compatibility
		  new SP(  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0,       0,       0.    )},  // 4 - original comments removed for LaTeX compatibility

		 {new SP(  1.6559,  0.1355,  1.5356,  1.4983,  1.0375,  1.1006,  2.3728,  1.5854,  0.0436, -0.1797, -0.0344, -0.9096, -0.6062, -0.3939, -0.7278, -0.5486, -0.0166, -0.4009, -0.5519, -0.8824,  0.0000,  5.2553, -6.5076, -6.3774),   // 0 - original comments removed for LaTeX compatibility
		  new SP(  1.0980,  0.0899,  1.0183,  0.9935,  0.6880,  0.7298,  1.5734,  1.0513,  0.0289, -0.1192, -0.0228, -0.6032, -0.4020, -0.2612, -0.4826, -0.3638, -0.0110, -0.2658, -0.3660, -0.5851,  0.0000,  3.4848, -4.3152, -4.2289),   // 1 - original comments removed for LaTeX compatibility
		  new SP(  2.1239,  0.0697,  1.7384,  1.8623,  1.2839,  1.2617,  2.8732,  1.7961, -0.0715, -0.4354, -0.1518, -1.0900, -0.6191, -0.5098, -0.8548, -0.8930, -0.0795, -0.5002, -0.6018, -1.1907,  0.0000,  5.0979,  2.7147,  0.8467),   // 2 - original comments removed for LaTeX compatibility
		  new SP(  1.3666,  0.0448,  1.1186,  1.1983,  0.8261,  0.8118,  1.8487,  1.1557, -0.0460, -0.2802, -0.0977, -0.7013, -0.3984, -0.3280, -0.5500, -0.5746, -0.0512, -0.3218, -0.3872, -0.7661,  0.0000,  3.2802,  1.7467,  0.5448),   // 3 - original comments removed for LaTeX compatibility
		  new SP(  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0,       0,       0.    )}}; // 4 - original comments removed for LaTeX compatibility

		//original comments removed for LaTeX compatibility
