...
public class RComboWriterLim extends RTools {
	...
	public static final int DES_COL_END = 9;
	...
	public static void main(String[] args) {
		writeLogRegScript("log-reg-combo-filt.R", "acetyl-rcsb.csv", "sirt-rcsb.csv");
	}
	...
	private static void writeMakeTable(LabeledList<String> lines) {
		...
		lines.add("aucs = array(dim = c(33, 32736))\n");
