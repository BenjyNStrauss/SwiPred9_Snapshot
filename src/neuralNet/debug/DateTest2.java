...
public class DateTest2 extends LocalToolBase {
	private static final int[] SIZES = { 34, 12, 7 };
	...
	public static void main(String[] args) {
		...
		FFNeuralNet nn = new FFNeuralNet(SIZES, FUNCT, new BinaryCrossEntropy());
		NNLoader loader = new NNLoader(nn, inOut.x, inOut.y, EPOCHS, BATCH_SIZE, LEARNING_RATE);
		qp("loaded");
		loader.verbose = true;
		//Assist.qpln(loader.runOne());
		loader.runAllEpochs();
