...
public class conf_3 extends NetworkBase {
	private static final String DATA_FILE = DirectoryManager.FILES_PREDICT_SABLE + "/conf_3.txt";
	...
	public int net(float[] in, float[] out, int init) {
		...
		pUnit[] Hidden1 = pUnit.getUnits(Units, 279,280,281,282,283,284,285,286,287,288,289,290,291,292,293,294,295,296,297,298,299,300,301,302,303,304,305,306,307,308);
		pUnit[] Output1 = pUnit.getUnits(Units, 309,310);
		int[] Output = {309, 310};
