package dev.inProgress.sable.networksconfSA;
...
public class conf_5 extends NetworkBase {
	private static final String DATA_FILE = DirectoryManager.FILES_PREDICT_SABLE + "/conf_5.txt";
	...
	public int net(float[] in, float[] out, int init) {
		...
		pUnit[] Hidden1 = pUnit.getUnits(Units, 279,280,281,282,283,284,285,286,287,288,289,290,291,292,293,294,295,296,297,298,299,300,301,302,303,304,305,306,307,308,309,310,311,312,313,314,315,316,317,318,319,320,321,322,323,324,325,326,327,328);
		pUnit[] Output1 = pUnit.getUnits(Units, 329,330);
		int[] Output = {329, 330};
