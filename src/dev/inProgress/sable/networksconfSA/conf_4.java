...
public class conf_4 extends NetworkBase {
	private static final String DATA_FILE = DirectoryManager.FILES_PREDICT_SABLE + "/conf_4.txt";
	...
	public int net(float[] in, float[] out, int init) {
		...
		pUnit[] Output1 = pUnit.getUnits(Units, 330,331);
		int[] Output = {330, 331};
