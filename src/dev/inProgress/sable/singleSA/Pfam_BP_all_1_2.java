...
public class Pfam_BP_all_1_2 extends NetworkBase {
	private static final String DATA_FILE = DirectoryManager.FILES_PREDICT_SABLE + "/Pfam_BP_all_1_2.txt";
