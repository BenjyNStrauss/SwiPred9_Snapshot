...
public class Pfam_BP_all_0_4 extends NetworkBase {
	private static final String DATA_FILE = DirectoryManager.FILES_PREDICT_SABLE + "/Pfam_BP_all_0_4.txt";
