...
public class Approx_elBP_1 extends NetworkBase {
	private static final String DATA_FILE = DirectoryManager.FILES_PREDICT_SABLE + "/Approx_elBP_1.txt";
