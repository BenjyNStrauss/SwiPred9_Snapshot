...
public class NNt extends CppTranslator implements Deconstructable {
	 ...
	 * @param t_NK
	 */
	public NNt(int t_NI, int t_NH, int t_NO, int[] t_NK) {
		NK=new int[NI];
		NItot=0;
		for (int i=0; i<NI; i++) {
			NK[i]=t_NK[i];
    ...
    public NNt(int t_NI,int t_NIr, int t_NH, int t_NO, int[] t_NK) {
    	this(t_NI, t_NIr, t_NH, t_NO, t_NK, 1, 1, 1);
    }


	public NNt(int t_NI,int t_NIr, int t_NH, int t_NO, int[] t_NK, int t_outp) {
		this(t_NI, t_NIr, t_NH, t_NO, t_NK, t_outp, 1, 1);
	}
    ...
    public NNt(int t_NI,int t_NIr, int t_NH, int t_NO, int[] t_NK,
    	...
    	NI=(t_NI); NIr=(t_NIr); NH=(t_NH);
    	NO=(t_NO); outp=(t_outp); inp=(t_inp);
