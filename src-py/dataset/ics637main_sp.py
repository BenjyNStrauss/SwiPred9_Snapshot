...
import dataset.ics637train_v2 as train

from dataset import loader, errors
...
def main(): 
    ...
    for run in range(start_model, num_models):
        ...
        #overrides
        layer_sizes = [37, 2544, 5964, 4686, 4456, 7987, 637, 173, 1]
        function = nn.Softsign()
